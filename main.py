...
parser.add_argument('--self_att', action='store_true', default=False,
                    help='self attention')
parser.add_argument('--model_name', default='classical')
parser.add_argument('--att_gauss_spatial', action='store_true', default=False,
                    help='training with attention gauss kernel')
parser.add_argument('--att_inv_q_spatial', action='store_true', default=False,
...
sw = SummaryWriter('results/' + model_name)
...
if args.att_gauss_spatial or args.att_inv_q_spatial or args.att_module or args.laplace_att:
    args.self_att = True
...
def test(epoch, sw):
    ...
    sw.add_scalar('test_error', test_error, epoch)
